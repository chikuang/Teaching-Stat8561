...
::: {.callout-definition title="Least Squares Estimator"}
...
Hence, the residual vector is orthogonal to every column of
$\mathbf{X}$ and therefore to every vector in
$\mathcal{C}(\mathbf{X})$:
...
::: {.callout-property title="Fundamental Orthogonal Decomposition"}
...
This orthogonal decomposition is the geometric foundation of least
squares regression.
...
::: {.callout-definition title="Residual-Maker Matrix"}
