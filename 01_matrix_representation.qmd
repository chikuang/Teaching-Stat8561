...
::: {.callout-definition title = "Simple linear regression"}
...
$$
\mathbb{E}[\mathbf{Y}] = \mathbf{X}\boldsymbol{\beta},\quad  \mathrm{Var}(\mathbf{Y}) = \sigma^2 \mathbf{I}_n.
$$
...
::: {.callout-definition title = "Column space"}
